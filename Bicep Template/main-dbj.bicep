...
var proximityGroupZone1Name = 'sap-dbj-1-${deploymentEnvironment}-ppg'
var rgName  = 'sap-dbj-${deploymentEnvironment}-rg'
...
param SID string = 'DBJ'
param ApplicationName string = 'SAP Portal VSP -  DBJ - Development'


param appServers array = [
  {
    vmName: 'azsapd011' 
    computerName: 'azsapd011'
    ...
    IPConfiguration: [
      {
        name: 'ipconfig1'
        primaryIP: true
        IPAddress: '10.192.96.38'
      }
      {
        name: 'sap-logical-hostname-sapdbj'
        primaryIP: false
        IPAddress: '10.192.96.39'
      }
      {
        name: 'sap-logical-hostname-sapdbjapp01'
        primaryIP: false
        IPAddress: '10.192.96.40'
      }
    ]
    dataDisks: [
      {
