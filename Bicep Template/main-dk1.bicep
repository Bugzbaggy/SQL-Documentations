...
var proximityGroupZone1Name = 'sap-dk1-1-${deploymentEnvironment}-ppg'
var rgName  = 'sap-dk1-${deploymentEnvironment}-rg'
...
param SID string = 'DK1'
param ApplicationName string = 'SAP NFE dk1 - Development'


param appServers array = [
  {
    vmName: 'azsapd010' 
    computerName: 'azsapd010'
    ...
    IPConfiguration: [
      {
        name: 'ipconfig1'
        primaryIP: true
        IPAddress: '10.192.96.35'
      }
      {
        name: 'sap-logical-hostname-sapdk1'
        primaryIP: false
        IPAddress: '10.192.96.36'
      }
      {
        name: 'sap-logical-hostname-sapdk1app01'
        primaryIP: false
        IPAddress: '10.192.96.37'
      }
    ]
    dataDisks: [
      {
