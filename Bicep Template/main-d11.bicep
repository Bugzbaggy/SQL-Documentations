...
param SID string = 'D11'
var SIDLower = toLower(SID)
param ApplicationName string = 'SAP PRIMAVERA D11 - Development'
    ...
    IPConfiguration: [
      {
        name: 'ipconfig1'
        primaryIP: true
        IPAddress: '10.192.96.44'
      }
      {
        name: 'sap-logical-hostname-sapd11'
        primaryIP: false
        IPAddress: '10.192.96.45'
      }
      {
        name: 'sap-logical-hostname-sapd11app01'
        primaryIP: false
        IPAddress: '10.192.96.46'
      }
    ]
    dataDisks: [
      {
