...
param SID string = 'PK1'
param ApplicationName string = 'SAP PK1 Production'
    ...
    IPConfiguration: [
      {
        name: 'ipconfig1'
        primaryIP: true
        IPAddress: '10.71.48.30'
      }
      {
        name: 'sap-logical-hostname-sappk1cs01'
        primaryIP: false
        IPAddress: '10.71.48.31'
      }
        ]
    dataDisks: [
      {
    ...
    IPConfiguration: [
      {
        name: 'ipconfig1'
        primaryIP: true
        IPAddress: '10.71.48.32'
      }
      {
        name: 'sap-logical-hostname-sappk1cs02'
        primaryIP: false
        IPAddress: '10.71.48.33'
      }
        ]
    dataDisks: [
      {
    ...
    IPConfiguration: [
      {
        name: 'ipconfig1'
        primaryIP: true
        IPAddress: '10.71.48.35'
      }
      {
        name: 'sap-logical-hostname-sappk1app01'
        primaryIP: false
        IPAddress: '10.71.48.36'
      }
    ...
    IPConfiguration: [
      {
        name: 'ipconfig1'
        primaryIP: true
        IPAddress: '10.71.48.37'
      }
      {
        name: 'sap-logical-hostname-sappk1app02'
        primaryIP: false
        IPAddress: '10.71.48.38'
      }
    ...
    IPConfiguration: [
      {
        name: 'ipconfig1'
        primaryIP: true
        IPAddress: '10.71.50.18'
      }
      {
        name: 'sap-logical-hostname-sappk1db01'
        primaryIP: false
        IPAddress: '10.71.50.19'
      }
    ...
    IPConfiguration: [
      {
        name: 'ipconfig1'
        primaryIP: true
        IPAddress: '10.71.50.20'
      }
      {
        name: 'sap-logical-hostname-sappk1db02'
        primaryIP: false
        IPAddress: '10.71.50.21'
      }
