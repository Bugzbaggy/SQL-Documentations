...
param SID string = 'DR1'
var SIDLower = toLower(SID)
param ApplicationName string = 'SAP CPS-Redwood DR1 - Development'
    ...
    IPConfiguration: [
      {
        name: 'ipconfig1'
        primaryIP: true
        IPAddress: '10.192.96.48'
      }
      {
        name: 'sap-logical-hostname-sapdr1'
        primaryIP: false
        IPAddress: '10.192.96.49'
      }
      {
        name: 'sap-logical-hostname-sapdr1app01'
        primaryIP: false
        IPAddress: '10.192.96.50'
      }
    ]
    dataDisks: [
      {
