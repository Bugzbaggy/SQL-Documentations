...
param SID string = 'D1L'
param ApplicationName string = 'SAP SLT - Development'

var proximityGroupZone1Name = 'sap-d1l-1-${deploymentEnvironment}-ppg'
var rgName  = 'sap-d1l-${deploymentEnvironment}-rg'
    ...
    IPConfiguration: [
      {
        name: 'ipconfig1'
        primaryIP: true
        IPAddress: '10.192.96.41'
      }
      {
        name: 'sap-logical-hostname-sapd1l'
        primaryIP: false
        IPAddress: '10.192.96.42'
      }
      {
        name: 'sap-logical-hostname-sapd1lapp01'
        primaryIP: false
        IPAddress: '10.192.96.43'
      }
    ]
    dataDisks: [
      {
