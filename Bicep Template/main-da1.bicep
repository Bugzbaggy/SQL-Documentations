...
var proximityGroupZone1Name = 'sap-da1-1-${deploymentEnvironment}-ppg'
var rgName  = 'sap-da1-${deploymentEnvironment}-rg'
...
param SID string = 'DA1'
param ApplicationName string = 'SAP ADS DA1 - Development'


param appServers array = [
  {
    vmName: 'azsapd008' 
    computerName: 'azsapd008'
    ...
    IPConfiguration: [
      {
        name: 'ipconfig1'
        primaryIP: true
        IPAddress: '10.192.96.29'
      }
      {
        name: 'sap-logical-hostname-sapda1'
        primaryIP: false
        IPAddress: '10.192.96.30'
      }
      {
        name: 'sap-logical-hostname-sapda1app01'
        primaryIP: false
        IPAddress: '10.192.96.31'
      }
    ]
    dataDisks: [
      {
