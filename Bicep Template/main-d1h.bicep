...
param SID string = 'D1H'
var SIDLower = toLower(SID)
param ApplicationName string = 'SAP HANA readiness D1H - Development'
    ...
    IPConfiguration: [
      {
        name: 'ipconfig1'
        primaryIP: true
        IPAddress: '10.192.96.51'
      }
      {
        name: 'sap-logical-hostname-sapd1h'
        primaryIP: false
        IPAddress: '10.192.96.52'
      }
      {
        name: 'sap-logical-hostname-sapdd1happ01'
        primaryIP: false
        IPAddress: '10.192.96.53'
      }
    ]
    dataDisks: [
      {
