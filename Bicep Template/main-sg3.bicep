...
param SID string = 'SG3'
param ApplicationName string = 'SAP GRC SG3'
    ...
    IPConfiguration: [
      {
        name: 'ipconfig1'
        primaryIP: true
        IPAddress: '10.192.96.57'
      }
      {
        name: 'sap-logical-hostname-sapsg3'
        primaryIP: false
        IPAddress: '10.192.96.58'
      }
      {
        name: 'sap-logical-hostname-sapsg3app01'
        primaryIP: false
        IPAddress: '10.192.96.59'
      }
    ]
    dataDisks: [
      {
