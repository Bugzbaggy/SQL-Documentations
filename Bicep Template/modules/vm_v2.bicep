...
resource vm 'Microsoft.Compute/virtualMachines@2020-12-01' =  {
  ...
  location: location
  tags: {
    'operating-system': operatingSystemValues[operatingSystem].PublisherValue == 'RedHat' ? 'linux-redhat' : 'windows'
    'firewall-group' : networkTags
    'SLA-Server' :  sla
    'Backup' : backup
     }
  properties: {
    ...
    osProfile: {
      ...
      adminPassword: adminPassword
        ...
        patchSettings: {
          patchMode: operatingSystemValues[operatingSystem] == 'MSSQL2017WS2019' ? 'AutomaticByPlatform' : 'AutomaticByOS'
        }
              }
    }
    storageProfile: {
