...
param ApplicationName string = 'SAP Jumphost'
var proximityGroupZone1Name = 'sap-jump-1-${deploymentEnvironment}-ppg'
var rgName  = 'sap-jump-${deploymentEnvironment}-rg'
